    ...
    <>
      <div className="h-screen bg-gradient-to-r from-[#184352] to-[#184352]">
        ...
        <div className="absolute mt-16">
          <div className="p-10 opacity-60 flex flex-wrap gap-32">
            {games.map((game : Games) => (
              <div className="m-1 w-[35%] bg-slate-700" key={game.id}>
                <img
                  src={game.image}
                ...
                <p>
                  Support url and email : {game.supportURL} {game.supportEmail}
                </p>
                <p>
